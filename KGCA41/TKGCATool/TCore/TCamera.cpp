...
void TCamera::CreateOrthoProjMatrix(float fWidth, float fHeight, float fNear, float fFar)
{
	D3DXMatrixOrthoOffCenterLH(&m_matProj,-fWidth / 2, fWidth / 2, -fFar / 2, fFar / 2, fNear, fFar);
}
bool TCamera::Frame()
{
	TVector3 vUp = { 0,1,0 };
