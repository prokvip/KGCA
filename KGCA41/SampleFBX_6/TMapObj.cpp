...
bool	TMapObj::PostRender()
{
	...
	//m_pImmediateContext->UpdateSubresource(m_pFbxObject->m_pBoneCB, 0, NULL, &m_pFbxObject->m_matBoneArray, 0, 0);
	//m_pImmediateContext->VSSetConstantBuffers(2, 1, &m_pFbxObject->m_pBoneCB);
