...
void TOctree::BuildTree(TNode* pNode)
{
    ...
    TPoint3 vTC1 = { pNode->m_tBox.m_Center.x, pNode->m_tBox.m_Point[0].y, 
                     pNode->m_tBox.m_Min.z };
    TPoint3 vRC1 = { pNode->m_tBox.m_Point[1].x, pNode->m_tBox.m_Center.y,
                    pNode->m_tBox.m_Min.z };
    TPoint3 vBC1 = { pNode->m_tBox.m_Center.x, pNode->m_tBox.m_Point[3].y,
                    pNode->m_tBox.m_Min.z };
    TPoint3 vLC1 = { pNode->m_tBox.m_Point[0].x, pNode->m_tBox.m_Center.y,
                    pNode->m_tBox.m_Min.z };

    TPoint3 vTC2 = { pNode->m_tBox.m_Center.x, pNode->m_tBox.m_Point[0].y,
                    pNode->m_tBox.m_Center.z };
    TPoint3 vRC2 = { pNode->m_tBox.m_Point[1].x, pNode->m_tBox.m_Center.y,
                    pNode->m_tBox.m_Center.z };
    TPoint3 vBC2 = { pNode->m_tBox.m_Center.x, pNode->m_tBox.m_Point[3].y,
                    pNode->m_tBox.m_Center.z };
    TPoint3 vLC2 = { pNode->m_tBox.m_Point[0].x, pNode->m_tBox.m_Center.y,
                    pNode->m_tBox.m_Center.z };

    TPoint3 vTC3 = { pNode->m_tBox.m_Center.x, pNode->m_tBox.m_Point[0].y,
                    pNode->m_tBox.m_Max.z };
    TPoint3 vRC3 = { pNode->m_tBox.m_Point[1].x, pNode->m_tBox.m_Center.y,
                    pNode->m_tBox.m_Max.z };
    TPoint3 vBC3 = { pNode->m_tBox.m_Center.x, pNode->m_tBox.m_Point[3].y,
                    pNode->m_tBox.m_Point[0].z };
    TPoint3 vLC3 = { pNode->m_tBox.m_Point[0].x, pNode->m_tBox.m_Center.y,
                    pNode->m_tBox.m_Max.z };
    ...
    std::cout << "[" << pNode->m_iDepth << "]"
        ...
        << pNode->m_tBox.m_fy << ","
        << pNode->m_tBox.m_fz << ","
        << pNode->m_tBox.m_fWidth << ","
        << pNode->m_tBox.m_fHeight<< ","
