...
namespace std
{
	template<> struct less<TBasisFBX::TRectangle>
	{
		bool operator()(const TBasisFBX::TRectangle& r1, const TBasisFBX::TRectangle& r2) const
		{
			return ((r1.x < r2.x)
				|| ((r1.x == r2.x) && (r1.y < r2.y))
	...
	template<> struct less<TBasisFBX::TVector2>
	{
		bool operator()(const TBasisFBX::TVector2& V1, const TBasisFBX::TVector2& V2) const
		{
			return ((V1.x < V2.x) || ((V1.x == V2.x) && (V1.y < V2.y)));
		}
	};

	template<> struct less<TBasisFBX::TVector3>
	{
		bool operator()(const TBasisFBX::TVector3& V1, const TBasisFBX::TVector3& V2) const
		{
			return ((V1.x < V2.x)
				|| ((V1.x == V2.x) && (V1.y < V2.y))
	...
	template<> struct less<TBasisFBX::TVector4>
	{
		bool operator()(const TBasisFBX::TVector4& V1, const TBasisFBX::TVector4& V2) const
		{
			return ((V1.x < V2.x)
				|| ((V1.x == V2.x) && (V1.y < V2.y))
				|| ((V1.x == V2.x) && (V1.y == V2.y) && (V1.z < V2.z))
	...
	template<> struct less<TBasisFBX::TMatrix>
	{
		bool operator()(const TBasisFBX::TMatrix& M1, const TBasisFBX::TMatrix& M2) const
		{
	...
	template<> struct less<TBasisFBX::TPlane>
	{
		bool operator()(const TBasisFBX::TPlane& P1, const TBasisFBX::TPlane& P2) const
		{
			return ((P1.x < P2.x)
				|| ((P1.x == P2.x) && (P1.y < P2.y))
	...
	template<> struct less<TBasisFBX::TQuaternion>
	{
		bool operator()(const TBasisFBX::TQuaternion& Q1, const TBasisFBX::TQuaternion& Q2) const
		{
			return ((Q1.x < Q2.x)
				|| ((Q1.x == Q2.x) && (Q1.y < Q2.y))
	...
	template<> struct less<TBasisFBX::TColor>
	{
		bool operator()(const TBasisFBX::TColor& C1, const TBasisFBX::TColor& C2) const
		{
			return ((C1.x < C2.x)
				|| ((C1.x == C2.x) && (C1.y < C2.y))
	...
	template<> struct less<TBasisFBX::TRay>
	{
		bool operator()(const TBasisFBX::TRay& R1, const TBasisFBX::TRay& R2) const
		{
	...
	template<> struct less<TBasisFBX::TViewport>
	{
		bool operator()(const TBasisFBX::TViewport& vp1, const TBasisFBX::TViewport& vp2) const
		{
